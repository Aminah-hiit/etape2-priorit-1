...
WebUI.click(findTestObject('finance/verification-contacts/page_iad/a_Myiad'))

WebUI.setText(findTestObject('finance/verification-contacts/page_iad/input_Afficher_search'), GlobalVariable.PrenomAcq2)

WebUI.verifyElementPresent(findTestObject('finance/verification-contacts/page_iad/a_acquadd12449-acquadd22449'), 5, FailureHandling.OPTIONAL)

SearchPrenom = WebUI.getText(findTestObject('finance/verification-contacts/page_iad/a_acquadd12449-acquadd22449'))
...
WebUI.setText(findTestObject('finance/verification-contacts/page_iad/input_Afficher_search'), GlobalVariable.Prenom)

not_run: WebUI.click(findTestObject('Etape2/Verification-contacts/Page_IAD/div_Filtres_iad-list-item-title'))

WebUI.delay(3)

WebUI.click(findTestObject('finance/verification-contacts/page_iad/a_acquadd1638-acquadd2638'))

WebUI.delay(2)

if (WebUI.verifyElementPresent(findTestObject('finance/creation_contact/page_iad/input_Prnom_firstName'), 5, FailureHandling.OPTIONAL)) {
	firstname1 = WebUI.getAttribute(findTestObject('finance/creation_contact/page_iad/input_Prnom_firstName'), 'value')
...
if (WebUI.verifyElementPresent(findTestObject('finance/creation_contact/page_iad/input_Nom_lastName'), 5, FailureHandling.OPTIONAL)) {
	lasname1 = WebUI.getAttribute(findTestObject('finance/creation_contact/page_iad/input_Nom_lastName'), 'value')
...
if (WebUI.verifyElementPresent(findTestObject('finance/creation_contact/page_iad/input_concat(Nom-usage)_usageName'), 5,
	FailureHandling.OPTIONAL)) {
	usedname1 = WebUI.getAttribute(findTestObject('finance/creation_contact/page_iad/input_concat(Nom-usage)_usageName'), 'value')
...
if (WebUI.verifyElementPresent(findTestObject('finance/creation_contact/page_iad/input_nom-jeune fille_birthName'), 5,
	FailureHandling.OPTIONAL)) {
	jeunefille1 = WebUI.getAttribute(findTestObject('finance/creation_contact/page_iad/input_nom-jeune fille_birthName'), 'value')
...
if (WebUI.verifyElementPresent(findTestObject('finance/creation_contact/page_iad/input_date-naissance_birth_date'), 5, FailureHandling.OPTIONAL)) {
	datebirth1 = WebUI.getAttribute(findTestObject('finance/creation_contact/page_iad/input_date-naissance_birth_date'), 'value')
...
if (WebUI.verifyElementPresent(findTestObject('finance/creation_contact/page_iad/input_lieu-naissance_birthPlace'), 5,
	FailureHandling.OPTIONAL)) {
	lieuNaiss1 = WebUI.getAttribute(findTestObject('finance/creation_contact/page_iad/input_lieu-naissance_birthPlace'), 'value')
...
if (WebUI.verifyElementPresent(findTestObject('finance/creation_contact/Span-modif/page_iad/span_FRANCE'), 5, FailureHandling.OPTIONAL)) {
	pays2 = WebUI.getText(findTestObject('finance/creation_contact/page_iad/span_FRANCE'))
...
if (WebUI.verifyElementPresent(findTestObject('finance/creation_contact/page_iad/input_Profession_job'), 5, FailureHandling.OPTIONAL)) {
	profession1 = WebUI.getAttribute(findTestObject('finance/creation_contact/page_iad/input_Profession_job'), 'value')
...
WebUI.click(findTestObject('finance/creation_contact/page_iad/div_contact-adresse'))

WebUI.delay(2)

if (WebUI.verifyElementPresent(findTestObject('finance/creation_contact/page_iad/input_Tlphone_phone2'), 5, FailureHandling.OPTIONAL)) {
	phone11 = WebUI.getAttribute(findTestObject('finance/creation_contact/page_iad/input_Tlphone_phone2'), 'value')
...
if (WebUI.verifyElementPresent(findTestObject('finance/creation_contact/page_iad/input_Tlphone_phone4'), 5, FailureHandling.OPTIONAL)) {
	phone22 = WebUI.getAttribute(findTestObject('finance/creation_contact/page_iad/input_Tlphone_phone4'), 'value')
...
if (WebUI.verifyElementPresent(findTestObject('finance/creation_contact/page_iad/input_e-mail-personnel_emailpersonal-3'),
	5, FailureHandling.OPTIONAL)) {
	email11 = WebUI.getAttribute(findTestObject('finance/creation_contact/page_iad/input_e-mail-personnel_emailpersonal-3'), 'value')
...
if (WebUI.verifyElementPresent(findTestObject('finance/creation_contact/page_iad/input_E-mail personnel_emailPersonal-5'),
	5, FailureHandling.OPTIONAL)) {
	email22 = WebUI.getAttribute(findTestObject('finance/creation_contact/page_iad/input_E-mail personnel_emailPersonal-5'), 'value')
...
if (WebUI.verifyElementPresent(findTestObject('finance/creation_contact/page_iad/input_france_form-control-ui-select-search _8034ae'),
	5, FailureHandling.OPTIONAL)) {
	pays3 = WebUI.getAttribute(findTestObject('finance/creation_contact/page_iad/input_france_form-control-ui-select-search _8034ae'),
		'value')
...
if (WebUI.verifyElementPresent(findTestObject('finance/creation_contact/page_iad/input_Adresse_address1'), 5, FailureHandling.OPTIONAL)) {
	adresse1 = WebUI.getAttribute(findTestObject('finance/creation_contact/page_iad/input_Adresse_address1'), 'value')
