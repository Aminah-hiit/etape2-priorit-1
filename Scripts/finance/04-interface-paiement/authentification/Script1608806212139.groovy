...
WebUI.navigateToUrl('https://p1.demo.iadholding.com/')

WebUI.maximizeWindow()

WebUI.click(findTestObject('finance/04-suivi-de-rem/button_accder'))

WebUI.setText(findTestObject('finance/04-suivi-de-rem/input_identifiant_username'), '293@iadfrance.fr')

WebUI.setEncryptedText(findTestObject('finance/04-suivi-de-rem/input_mot-de-passe_password'), 'M1qipU8GjAM=')
