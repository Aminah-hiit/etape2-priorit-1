...
WebUI.callTestCase(findTestCase('finance/03- suivi-rem/ct-01-authentification-conseiller'), [:], FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.verifyElementPresent(findTestObject('04-suivi-de-rem/div_Valider'), 0)
